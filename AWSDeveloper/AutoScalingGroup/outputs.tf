...
output "first_instance" {
  ...
  value       = aws_instance.asg_first_instance
}

output "second_instance" {
  description = "second instance"
  value       = aws_instance.asg_second_instance.id
}

output "third_instance" {
  description = "third instance"
  value       = aws_instance.asg_third_instance.id
}

output "az_output" {
  description = "third instance"
  value       = aws_instance.asg_first_instance.subnet_id
...
output "z-alb_security_group" {
  value = module.asg_alb_security_group
}

output "z-arn-listener" {
  value = module.asg_alb
}
